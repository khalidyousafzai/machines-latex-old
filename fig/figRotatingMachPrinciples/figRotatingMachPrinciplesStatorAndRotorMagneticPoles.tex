...
\draw node at (-90-15:\sRi+2*\gap){$a'$};
%
\draw[-latex] (0:0.8*\rR)--++(0:0.6cm)node[xshift=0.2cm]{$S_a$};
\draw[latex-] (180:0.8*\rR)--++(180:0.6cm)node[xshift=-0.2cm]{$N_a$};
%ROTOR
...
\draw (\rTilt-90:\rR-\delR/2)++(-45:2.2pt)--++(135:4.4pt); 
%
\draw[-latex] (\rTilt:0.8*\rR)node[shift={(180+\rTilt:0.2cm)}]{$N_r$}--++(\rTilt:0.6cm);
\draw[latex-] (180+\rTilt:0.8*\rR)node[shift={(\rTilt:0.25cm)}]{$S_r$}--++(180+\rTilt:0.6cm);
%text)
\draw node at (\rTilt+90+25:\rR-\pY){$r$};
\draw node at (\rTilt-90+30:\rR-\pY){$r'$};
\end{scope}
